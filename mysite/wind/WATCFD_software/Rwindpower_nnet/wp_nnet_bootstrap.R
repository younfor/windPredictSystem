...
plot(nn1_out,y1_out,type="l", col="blue" ,lwd = 2,ylim=c(ylim_low, ylim_high), ylab="Wind power" , xlab="Hour", col.lab="blue" )
...
plot(nn1,y1_in,  ylim=c(ylim_low, ylim_high) , xlim=c(1, nn), type="l", col="blue", lwd = 2 ,ylab="Wind power" , xlab="Hour", col.lab="blue" )
...
plot(nn1_out, data2[-nn1,], ylim=c(ylim_low, ylim_high) , xlim=c(1, nn2),type="l", col="blue" ,lwd = 2 ,ylab="Wind power" , xlab="Hour", col.lab="blue")
...
plot(nn1, data2[nn1,], ylim=c(ylim_low, ylim_high) , xlim=c(1, nn), type="l", col="blue", lwd = 2 ,ylab="Wind power" , xlab="Hour", col.lab="blue")
