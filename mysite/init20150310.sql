...
INSERT INTO "django_migrations" VALUES(1,'contenttypes','0001_initial','2015-01-15 10:08:26.950857');
INSERT INTO "django_migrations" VALUES(2,'auth','0001_initial','2015-01-15 10:08:27.231340');
INSERT INTO "django_migrations" VALUES(3,'admin','0001_initial','2015-01-15 10:08:27.511624');
INSERT INTO "django_migrations" VALUES(4,'sessions','0001_initial','2015-01-15 10:08:27.769883');
INSERT INTO "django_migrations" VALUES(5,'wind','0001_initial','2015-01-15 10:08:28.140722');
INSERT INTO "django_migrations" VALUES(6,'wind','0002_auto_20150107_0852','2015-01-15 10:08:28.810346');
...
INSERT INTO "django_content_type" VALUES(8,'factory','wind','factory');
INSERT INTO "django_content_type" VALUES(9,'power station','wind','powerstation');
INSERT INTO "django_content_type" VALUES(10,'wind turbine','wind','windturbine');
INSERT INTO "django_content_type" VALUES(11,'location','wind','location');
...
INSERT INTO "auth_permission" VALUES(22,'Can add factory',8,'add_factory');
INSERT INTO "auth_permission" VALUES(23,'Can change factory',8,'change_factory');
INSERT INTO "auth_permission" VALUES(24,'Can delete factory',8,'delete_factory');
INSERT INTO "auth_permission" VALUES(25,'Can add power station',9,'add_powerstation');
INSERT INTO "auth_permission" VALUES(26,'Can change power station',9,'change_powerstation');
INSERT INTO "auth_permission" VALUES(27,'Can delete power station',9,'delete_powerstation');
INSERT INTO "auth_permission" VALUES(28,'Can add wind turbine',10,'add_windturbine');
INSERT INTO "auth_permission" VALUES(29,'Can change wind turbine',10,'change_windturbine');
INSERT INTO "auth_permission" VALUES(30,'Can delete wind turbine',10,'delete_windturbine');
INSERT INTO "auth_permission" VALUES(31,'Can add location',11,'add_location');
INSERT INTO "auth_permission" VALUES(32,'Can change location',11,'change_location');
INSERT INTO "auth_permission" VALUES(33,'Can delete location',11,'delete_location');
...
INSERT INTO "auth_user" VALUES(1,'pbkdf2_sha256$12000$8gHp3FgXuRbK$pRvb7YaSGxC8OhhynY0peN4KqsKTRcms8gmh/bNnnhk=','2015-03-10 10:37:55.279283',1,'super','','','super@super.com',1,1,'2015-03-09 06:39:01');
...
CREATE TABLE "wind_powerdata" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "time" varchar(30) NOT NULL, "NWP_speed" varchar(30) NOT NULL, "CFD_speed" varchar(30) NOT NULL, "Observed_speed" varchar(30) NOT NULL, "Observed_power" varchar(30) NOT NULL, "Predicted_speed" varchar(30) NOT NULL, "Speed_dev" varchar(30) NOT NULL, "Predicted_power" varchar(30) NOT NULL, "Power_dev" varchar(30) NOT NULL, "turbine_id" integer NOT NULL UNIQUE REFERENCES "wind_windturbine" ("id"));
CREATE TABLE "wind_factory" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(30) NOT NULL, "province" varchar(50) NOT NULL, "state" varchar(50) NOT NULL, "country" varchar(50) NOT NULL, "city" varchar(50) NOT NULL, "contact" varchar(30) NOT NULL, "telephone" varchar(30) NOT NULL, "email" varchar(75) NOT NULL, "bank_account" varchar(30) NOT NULL, "user_id" integer NOT NULL UNIQUE REFERENCES "auth_user" ("id"), "begintime" datetime NULL, "endtime" datetime NULL, "location_id" integer NULL UNIQUE REFERENCES "wind_location" ("id"));
CREATE TABLE "wind_powerstation" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(30) NOT NULL, "province" varchar(50) NOT NULL, "country" varchar(50) NOT NULL, "city" varchar(50) NOT NULL, "contact" varchar(30) NOT NULL, "telephone" varchar(30) NOT NULL, "email" varchar(75) NOT NULL, "bank_account" varchar(30) NOT NULL, "factory_id" integer NOT NULL REFERENCES "wind_factory" ("id"), "user_id" integer NOT NULL UNIQUE REFERENCES "auth_user" ("id"), "begintime" datetime NULL, "endtime" datetime NULL, "location_id" integer NULL UNIQUE REFERENCES "wind_location" ("id"));
CREATE TABLE "wind_windturbine" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(30) NOT NULL, "longitude" varchar(12) NOT NULL, "latitude" varchar(12) NOT NULL, "contact" varchar(30) NOT NULL, "telephone" varchar(30) NOT NULL, "email" varchar(75) NOT NULL, "powerstation_id" integer NOT NULL REFERENCES "wind_powerstation" ("id"), "user_id" integer NOT NULL UNIQUE REFERENCES "auth_user" ("id"), "begintime" datetime NULL, "endtime" datetime NULL, "location_id" integer NULL UNIQUE REFERENCES "wind_location" ("id"));
